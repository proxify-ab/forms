...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
         ...
         */
        setCustomValue: function setCustomValue(cv) {
            this.value = cv;
        },
        ...
        [
          _c("template", { slot: "field" }, [
            _c("textarea", {
              ...
              staticClass:
                "w-full form-control form-input form-input-bordered frm-data",
              class: _vm.errorClasses,
              staticStyle: { display: "none" },
              attrs: { id: _vm.field.name, type: "text" },
